...
func main() {
	...
	protected.Get("/chats/:chatID/invite-link", chatHandler.GetInviteLink)
	protected.Post("/chats/:chatID/invite-link/reset", chatHandler.ResetInviteLink)
	protected.Get("/chats/:chatID/permissions", chatHandler.GetPermissions)
	protected.Patch("/chats/:chatID/permissions", chatHandler.UpdatePermissions)
	protected.Get("/chats/:chatID/admin-actions", chatHandler.GetAdminActions)
	...
	protected.Patch("/chats/:chatID/members/:userID/role", chatHandler.SetMemberRole)
